...
public class SnapshotsInProgressSerializationTests extends AbstractDiffableWireSerializationTestCase<Custom> {
    ...
    public void testXContent() throws IOException {
        ...
        Map<ShardId, SnapshotsInProgress.ShardSnapshotStatus> newShards = new HashMap<>();
        newShards.put(
        ...
        newShards.put(
            ...
            new SnapshotsInProgress.ShardSnapshotStatus("nodeId", ShardState.FAILED, "failure-reason", new ShardGeneration("fail-gen"))
        );
