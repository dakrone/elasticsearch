...
public class NoopEngine extends Engine {
    ...
    public IndexResult index(Index index) throws IOException {
        throw new UnsupportedOperationException("indexing is not supported on a closed engine");
    }

    @Override
    public DeleteResult delete(Delete delete) throws IOException {
        throw new UnsupportedOperationException("deletion is not supported on a closed engine");
    }

    @Override
    public NoOpResult noOp(NoOp noOp) {
        throw new UnsupportedOperationException("noop is not supported on a closed engine");
    }

    @Override
    public SyncedFlushResult syncFlush(String syncId, CommitId expectedCommitId) throws EngineException {
        throw new UnsupportedOperationException("synced flush is not supported on a closed engine");
    }

    @Override
    public GetResult get(Get get, BiFunction<String, SearcherScope, Searcher> searcherFactory) throws EngineException {
        throw new UnsupportedOperationException("gets are not supported on a closed engine");
    }
    ...
    public Searcher acquireSearcher(String source, SearcherScope scope) throws EngineException {
        throw new UnsupportedOperationException("searching is not supported on a closed engine");
    }
